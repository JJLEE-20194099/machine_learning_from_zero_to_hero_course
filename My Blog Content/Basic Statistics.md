...
***Chú ý:*** khi $n=1$ thì phân phối nhị thức có 1 tên gọi khác là ***phân phối Bec-nu-li***.

### 3.3 Phân phỗi chuẩn

Đây là một phân phối cực kì quan trọng và có một tên gọi nữa là phân phối $Gaussian$

Biến ngẫu nhiên $X$ được gọi là tuân theo phân phối chuẩn nếu hàm mật độ có dạng:

$$f(x) = \frac{1}{\sigma \sqrt{2 \pi}} e ^ {-\frac{(x - a)^2}{2 \sigma^2}}, x \in R$$

+ $a = EX$
+ $\sigma = \sqrt{VX}$

Ta có một số kết quả cơ bản như sau:
